...
var ModalDialogService = (function () {
    function ModalDialogService(dialog) {
        this.dialog = dialog;
    }
    ModalDialogService.prototype.openDialog = function (message, title, btnOkText, btnCancelText) {
        var dialogRef;
        dialogRef = this.dialog.open(modal_dialog_component_1.ModalDialogComponent);
