...
var PatientListService = (function () {
    function PatientListService(http, getConfig) {
        var _this = this;
        this.http = http;
        this.getPatientList = function (body) {
            return _this.http.post(_this.getPatientListServiceLink, body)
                .map(function (data) { return data.json(); });
        };
        this.getPatientResults = function (selectedPatientIds) {
            var body = JSON.stringify(selectedPatientIds.PatientIDs);
            return _this.http.post(_this.getPatientResultServiceLink, body)
                .map(function (data) { return data.json(); });
        };
        this.updateResults = function (body) {
            return _this.http.put(_this.updateResultServiceLink, body)
                .map(function (data) { return data.json(); });
        };
